...
$query = "SELECT e.matricula,t.nombre_taller, e.nombre_estudiante, e.ap_paterno, e.ap_materno, e.domicilio, e.genero,
            e.semestre, e.fecha_nac, f.nombre, c.nombrecarrera, e.id_puntaje, r.tipo, e.correo, e.contrasena
            FROM estudiante e
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            ...
            <div class="activity">
                ...
                <div class ="h">
                <a href="insertarAlumno.php">Nuevo Alumno</a>
                </div>
                <table id="myTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                            ...
                            <td class="a">
                                    <a href="editarAl.php?id=<?php echo $row['matricula']?>" class="b"><i class='bx bxs-edit-alt'></i></a>
                                    <a href="EliminarAlumno.php?id=<?php echo $row['matricula']?>"
                                     onclick="confirmarEliminacion(event)" class="c"><i class='bx bx-box'></i></a>
                                    <a href="AgregarArchivosA.php?id=<?php echo $row['matricula']?>" class="d"><i class='bx bx-file'></i></a>
                            </td>
                            </tr>
                           <?php     
                            }
