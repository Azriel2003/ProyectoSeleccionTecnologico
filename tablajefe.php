...
$query = "SELECT j.id_jefe,j.nombre,j.ap_paterno,j.ap_materno,r.tipo, j.correo
         FROM jefe j
         INNER JOIN roll r on j.id_roll=r.id_roll";
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            ...
            <div class="activity">
                ...
                <div class ="h">
                <a href="insertarJ.php">Nuevo Administrador</a>
                </div>
                <table id="myTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                            ...
                            <tr>
                            <td class="a"><?php echo $row['id_jefe']?></td>
                            ...
                            <td class="a">
                                    <a href="editarJ.php?id=<?php echo $row['id_jefe']?>" class="b"><i class='bx bxs-edit-alt'></i></a>
                                    <a href="eliminarJ.php?id=<?php echo $row['id_jefe']?>"
